...
describe('RelatedListings', () => {
  ...
  describe('Loading State', () => {
    it('shows loading spinner while fetching', () => {
      ...
      render(<RelatedListings listingId={mockListingId} currentUserId={mockCurrentUserId} />);
  ...
  describe('Related Listings Display', () => {
    ...
    it('fetches related listings on mount', async () => {
      ...
      await waitFor(() => {
        expect(global.fetch).toHaveBeenCalledWith(`/api/listings/${mockListingId}/related`);
      });
    });
