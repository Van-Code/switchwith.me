...
export default function Footer() {
  return (
    <footer
      className="border-t mt-auto py-8 bg-gradient-to-b from-transparent to-amber-100/60
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="text-center text-xs text-muted-foreground border-t pt-6 mb-4">
          This is a fan-made project and isn’t affiliated with Bay FC, the Golden State
          Valkyries, the NWSL, the WNBA, Ticketmaster, or any stadium or venue where these
          teams play.
        </div>
        {/* Copyright */}
