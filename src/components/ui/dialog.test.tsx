...
jest.mock("@radix-ui/react-dialog", () => ({
  ...
  Overlay: React.forwardRef(({ open, ...props }: any, ref: any) =>
    open ? <div ref={ref} data-testid="dialog-overlay" {...props} /> : null
  ),
  ...
  Close: ({ children, onClick, onOpenChange, asChild, ...props }: any) =>
    asChild ? (
      React.cloneElement(children, {
        onClick: (e: any) => {
          children.props.onClick?.(e)
